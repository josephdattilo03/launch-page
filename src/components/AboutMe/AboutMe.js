    ...
    render() {
        return(
            <div>
                ...
                <div data-aos = "fade-right" data-aos-delay="50" class="center">
                    <button class="flip-panel">
                        ...
                        <p class="background-text">I am so excited to study here in South Africa. Not only will it be amazing to enjoy the nature and explore the most beautiful parts of Cape Town, but this city is a major industry disruptor in software. I'll be able to work with companies that are making an impact
                        ...
                        <p class="center background-text">Click :)</p>
                    </button>
                </div>
            </div>
        )
